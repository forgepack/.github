...
- **Templates para novos repositórios** (Settings → Template repository):
  - `template-maven-library` — README, componentes relacionados, `pom.xml`, licença, CI básico
  - `template-npm-library` — README, componentes relacionados, `package.json`, licença, CI básico
