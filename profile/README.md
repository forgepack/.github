...
| [forgepack-validation](https://github.com/forgepack/forgepack-validation) | [![Maven Central](https://img.shields.io/forgepack-validation/v/dev.forgepack/forgepack-validation)](https://central.sonatype.com/artifact/dev.forgepack/forgepack-validation) | Constraints Bean Validation customizados (`@HasDigit`, `@HasLetter`, `@Unique`, etc.) | [`backend,validation`](https://github.com/orgs/forgepack/repositories?q=topic:backend,validation) |
